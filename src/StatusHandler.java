...
public class StatusHandler {
    ...
    public StatusHandler(String nome, int duracao, int dmgStatus, int atkChange, float dmgChange) {
        this.nome = nome;
    ...
    public StatusHandler(String nome, int duracao, int dmgStatus, int atkChange, float dmgChange, boolean statusIdle, String statusIdleMsg) {
        this.nome = nome;
        this.duracao = duracao;
        this.dmgStatus = dmgStatus;
        this.atkChange = atkChange;
    ...
    public static StatusHandler statusFuria(Entidade entidade, int turnoUso){
        int atkArma;
        try {
    ...
    public static StatusHandler statusFrenesi(Entidade entidade, int turnoUso){
        return new StatusHandler(
                "Frenesi",
                1,
                0,
    ...
    public static StatusHandler statusEvasao(Entidade entidade, int turnoUso){
        return new StatusHandler(
                "Evasão",
                1,
                0,
    ...
    public static StatusHandler searchStatus(String searchQuery, List<StatusHandler> searchLocale){
    ...
    public static boolean doesStatusExist(String searchQuery, List<StatusHandler> searchLocale){
        return searchLocale.stream()
